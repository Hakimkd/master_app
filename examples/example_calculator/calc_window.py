...
from PyQt5.QtWidgets import QPushButton, QInputDialog, QVBoxLayout, QCheckBox, QButtonGroup
...
class CalculatorWindow(NodeEditorWindow):
    ...
    def initUI(self):
        self.name_company = 'devpro'
        self.name_product = 'master app'
    ...
    #     self.qq = QVBoxLayout()
    #     self.qq.addWidget(self.cs_group)
    # def addgrp(self):
    #     CalcInputContent.initUI(self.qq)
    ...
    def about(self):
        QMessageBox.about(self, "About Calculator NodeEditor Example",
                "The <b>Master App</b> application demonstrates how control followers positions "
                )
    ...
    def updateWindowMenu(self):
        ...
        toolbar_nodes = self.windowMenu.addAction("Toolbar")
    ...
    def createNodesDock(self):
        ...
        self.nodesDock = QDockWidget("Menu")
